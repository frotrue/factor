...
export const TRANSLATIONS = {
    ko: {
        ...
        'tutorial.DATA_SOURCE.detail': '실리콘 지대 위에 추출기(Miner)를 배치해 실리콘을 캐내고, 패킷 수집기를 배치해 전파에서 Signal Packet 수집을 시작하세요.',
        ...
        'tutorial.CONNECTION.detail': '디지털 전송 기법을 사용하면 실리콘도 케이블로 보낼 수 있습니다! 이더넷 케이블로 추출기와 저장소(-64, 0)를 연결하고, 패킷 수집기와 프로세서를 연결하세요.',
        'tutorial.POWER.title': '전력 유지',
        'tutorial.POWER.detail': '코어는 주변 기계에 전력을 공급합니다. 전력이 부족하면 전력 건물을 추가하세요.',
        'tutorial.DEFENSE.title': '방어 준비',
        'tutorial.DEFENSE.detail': 'North Port 경로 근처에 Classifier를 배치해 첫 방어선을 만드세요.',
        'tutorial.RESEARCH.title': '연구 열기',
        'tutorial.RESEARCH.detail': '첫 방어 성공 후 신뢰도를 사용해 물류, 생산, 방어 업그레이드를 해금하세요.',
    ...
    en: {
        ...
        'tutorial.DATA_SOURCE.detail': 'Place an Extractor (Miner) on the Silicon patch to mine Silicon, and place a Packet Ingestor to gather signal packets from wireless networks.',
        ...
        'tutorial.CONNECTION.detail': 'Using digital transmission technology, Silicon is sent via network cables! Connect the Extractor to the Storage (-64, 0), and the Packet Ingestor to the Processor.',
        ...
        'tutorial.RESEARCH.detail': 'After the first successful defense, use confidence score to unlock better logistics, production, and defense upgrades.',
