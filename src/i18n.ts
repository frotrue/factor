...
export const TRANSLATIONS = {
    ko: {
        ...
        'tutorial.DATA_SOURCE.detail': '패킷 수집기를 배치해 처리 라인에 필요한 Signal Packet을 생산하세요.',
        ...
        'tutorial.CONNECTION.detail': 'Ethernet 케이블과 컨베이어로 생산자와 수신자를 연결하세요. AP와 고급 링크는 이후 확장 단계에서 다룹니다.',
        'tutorial.POWER.title': '전력 유지',
        'tutorial.POWER.detail': '코어는 주변 기계에 전력을 공급합니다. 전력이 부족하면 전력 건물을 추가하세요.',
        'tutorial.DEFENSE.title': '방어 준비',
        'tutorial.DEFENSE.detail': 'North Port 경로 근처에 Classifier 또는 Firewall을 배치해 첫 방어선을 만드세요.',
    ...
    en: {
        ...
        'tutorial.DATA_SOURCE.detail': 'Place a Packet Ingestor to produce Signal Packets for the processing chain.',
        ...
        'tutorial.CONNECTION.detail': 'Use Ethernet cable and conveyors to move items between producers and receivers. AP and advanced links come later.',
